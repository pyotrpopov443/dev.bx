...
//		};
	...
	public function testThatOperationDoesNotInvokeAfterActionsIfAfterActionsDisabledInSettings(): void
	{
		$settings = new App\Operation\Settings();
	...
	public function testThatAddInvalidActionThrowsException(): void
	{
		$order = $this->getMockBuilder(\App\Order::class)
			->getMock()
		;
		...
		{
			static::assertNotNull($operation);
		}
	}
